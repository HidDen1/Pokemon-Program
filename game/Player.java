...
public class Player{
    ...
    public void gainEVs(int currentID, double atk, double def, double spAtk, double spDef, double spd, double hp){
        if (party[currentID].getTotalEV() < 512 && party[currentID].getAtk().getEV() < 252){
            party[currentID].getAtk().setEV(party[currentID].getAtk().getEV() + atk);
            ...
            if (party[currentID].getAtk().getEV() > 252){
                atk = party[currentID].getAtk().getEV() - 252;
                party[currentID].getAtk().setEV(252);
                party[currentID].setTotalEv(party[currentID].getTotalEV() - atk);
            }
        }
        if (party[currentID].getTotalEV() < 512 && party[currentID].getDef().getEV() < 252){
            party[currentID].getDef().setEV(party[currentID].getDef().getEV() + def);
            ...
            if (party[currentID].getDef().getEV() > 252){
                def = party[currentID].getDef().getEV() - 252;
                party[currentID].getDef().setEV(252);
                party[currentID].setTotalEv(party[currentID].getTotalEV() - def);
            }
        }
        ...
        if (party[currentID].getTotalEV() < 512 && party[currentID].getSpDef().getEV() < 252){
            party[currentID].getSpDef().setEV(party[currentID].getSpDef().getEV() + spDef);
            ...
            if (party[currentID].getSpDef().getEV() > 252){
                spDef = party[currentID].getSpDef().getEV() - 252;
                party[currentID].getSpDef().setEV(252);
                party[currentID].setTotalEv(party[currentID].getTotalEV() - spDef);
            }
        }
    ...
    public void gainExperiencePokemon(int currentID, Pokedex pokedex){ //needs actual expMax calculations, needs changed in the event of multiple level ups at once, wont happen now cause set exp
        if (party[currentID].getLevel() < 100){
            ...
            if (party[currentID].getExperience() >= toLevelUpPokemon){
                ...
                party[currentID].getSpDef().setNum(((party[currentID].getSpDef().getBase() * 2 + party[currentID].getSpDef().getIV() + party[currentID].getSpDef().getEV() / 4) * party[currentID].getLevel() / 100 + 5) * party[currentID].nat.getSpDefBonus());
            ...
            if (party[currentID].getLevEv() == party[currentID].getLevel()){
                ...
                party[currentID].getSpDef().setBase(evolution.getSpDef().getBase());
            ...
            if (c > -1){
                ...
                switch (b){
                    case 1:
                        ...
                        System.out.println("Special Defense: " + party[c].getSpDef().getNum());
